...
export class DashboardComponent implements OnInit {
  ...
  public getSongByAlbum(album: string){
    this.router.navigate(['/songs'], { queryParams: { album: album } });
  }

  public getSongByCategory(category: string){
    this.router.navigate(['/songs'], { queryParams: { category: category } });
  }
